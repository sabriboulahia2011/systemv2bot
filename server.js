...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@3720859657769451591>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("guildMemberAdd", async member => {
  ...
  if (channel) {
    ...
    //Member Name
    var nameSize = "15pt"; //حجم خط الاسم
    var nameKind = "Tahoma (TTF)"; //نوع خط الاسم
    var nameColor = "#00FC12"; //لون خط الاسم
...
client.on("message", message => {
 ...
 عدد استخدامات الرابط : 100000000 **`);
